...
DIRmacs=./MACS/snpsplt_narrowpeaks_nodups_IgG2
...
#Define input IP control could also use [5]
fqname_IgG=${names[12]}
IGG_SPLTBAM_B6=$DIRsplitbam/${fqname_IgG}_bt2aln.genome1.bam
IGG_SPLTBAM_CAST=$DIRsplitbam/${fqname_IgG}_bt2aln.genome2.bam
...
-q 0.01 \
--bdg \
-n ${fqname}_B6_nodupsnarrowIgG2con \
--outdir $DIRmacs \
...
-q 0.01 \
--bdg \
-n ${fqname}_CAST_nodupsnarrowIgG2con \
--outdir $DIRmacs
